...
void send_packet(ENetPeer* peer, const std::string& packet, int flag = ENET_PACKET_FLAG_RELIABLE) {
	ENetPacket* enet_packet = enet_packet_create(packet.c_str(), packet.length(), flag);
